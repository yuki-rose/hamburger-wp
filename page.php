...
<body>
    <header class="l-header">
        ...
        <form class="p-search" action="#" method="get">
            <input class="p-search__input" type="search" name="search" placeholder=" &#xf002;" style="font-family: FontAwesome; color: #505050; font-size: 250%;"/>
    ...
    <main class="l-main">
        <figure class="c-mainvisual__page">
            <img src="./images/black-steel-lamp-post-1070945.jpg" alt="ハンバーガーの写真">
            <figcaption class="c-main__pagettl">ショップについて</figcaption>
        </figure>
        ...
        <div class="c-single__visual">
            <img src="./images/cooked-foods-750073.jpg" alt="ハンバーガーの写真">
        </div>
        ...
        <div class="c-single__wrapperGrid">
            <div class="c-single__wrapperGrid-item">
                <img class="c-single__wrapperGrid-img" src="./images/cooked-foods-750073.jpg" alt="ハンバーガーの写真">
            </div>
            <div class="c-single__wrapperGrid-item">
                <img class="c-single__wrapperGrid-img" src="./images/cooked-foods-750073.jpg" alt="ハンバーガーの写真">
            </div>
